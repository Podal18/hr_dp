    ...
    def fire_employee(self):
        ...
        try:
            ...
            with connection.cursor() as cursor:
                ...
                cursor.execute("SELECT user_id FROM employees WHERE id = %s", (self.selected_employee_id,))
                user_id_result = cursor.fetchone()

                if not user_id_result or 'user_id' not in user_id_result:
                    raise ValueError("Не удалось найти связанного пользователя для сотрудника")
